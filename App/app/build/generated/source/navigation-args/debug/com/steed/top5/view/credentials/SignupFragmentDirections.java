...
public class SignupFragmentDirections {
  ...
  @NonNull
  public static ActionSignupFragmentToMainActivity actionSignupFragmentToMainActivity() {
    return new ActionSignupFragmentToMainActivity();
  }

  public static class ActionSignupFragmentToMainActivity implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionSignupFragmentToMainActivity() {
    }

    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSignupFragmentToMainActivity setUserArg(@Nullable User userArg) {
    ...
    public boolean equals(Object object) {
      ...
      ActionSignupFragmentToMainActivity that = (ActionSignupFragmentToMainActivity) object;
    ...
    public String toString() {
      return "ActionSignupFragmentToMainActivity(actionId=" + getActionId() + "){"
          + "userArg=" + getUserArg()
          + "}";
    }
  }
