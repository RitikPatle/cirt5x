...
public abstract class FragmentHomeBinding extends ViewDataBinding {
  ...
  @NonNull
  public final View adBannerTopGap;
  ...
  protected FragmentHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      AdView adBanner, View adBannerTopGap, ConstraintLayout loadedLayout,
      ConstraintLayout loadingLayout, NestedScrollView mainLayout, ConstraintLayout noneLayout,
      RecyclerView preferenceItemsList, View preferenceItemsListTopSpace, ProgressBar progressBar,
      TextView statusTxt) {
    super(_bindingComponent, _root, _localFieldCount);
    this.adBanner = adBanner;
    this.adBannerTopGap = adBannerTopGap;
