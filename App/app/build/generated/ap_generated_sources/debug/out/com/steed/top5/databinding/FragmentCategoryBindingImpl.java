...
public class FragmentCategoryBindingImpl extends FragmentCategoryBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.preference_items_list_top_space, 2);
        sViewsWithIds.put(R.id.loadedLayout, 3);
        sViewsWithIds.put(R.id.categoryRecyclerView, 4);
        sViewsWithIds.put(R.id.noneLayout, 5);
        sViewsWithIds.put(R.id.statusTxt, 6);
