...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.header_start_gap, 3);
        sViewsWithIds.put(R.id.filterBtn, 4);
        sViewsWithIds.put(R.id.greetingsUser, 5);
        sViewsWithIds.put(R.id.userBtn, 6);
        sViewsWithIds.put(R.id.header_end_gap, 7);
        sViewsWithIds.put(R.id.logout_txt_end_gap, 8);
        sViewsWithIds.put(R.id.logoutTxt, 9);
        sViewsWithIds.put(R.id.header_bottom_border, 10);
        sViewsWithIds.put(R.id.footerLayout, 11);
        sViewsWithIds.put(R.id.footer_top_border, 12);
